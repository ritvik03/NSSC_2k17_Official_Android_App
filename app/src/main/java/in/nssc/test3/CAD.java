...
public class CAD extends AppCompatActivity {
    ...
    private void toEventfrmCAD() {
        Intent toEvefrmCAD = new Intent(this,Events2.class);
        startActivity(toEvefrmCAD);
    }
    ...
    public void toVikram3(View view) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    tab1cad tab1cd= new tab1cad();
                    return tab1cd;
                case 1:
                    tab2cad tab2cd= new tab2cad();
                    return tab2cd;
