...
public class PaperPresentation extends AppCompatActivity {
    ...
    private void toEventfrmPP() {
        Intent toEvefrmPP = new Intent(this,Events2.class);
        startActivity(toEvefrmPP);
    }
    ...
    public void toVikram5(View view) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    tab1pp tab1p= new tab1pp();
                    return tab1p;
                case 1:
                    tab2pp tab2p= new tab2pp();
                    return tab2p;
